    ...
    <div className="min-h-screen">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 bg-surface-900/60 backdrop-blur-xl border-b border-white/[0.04]">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/project/new-sketch"
            className="btn-secondary text-sm py-2 px-4 rounded-lg no-underline flex items-center gap-1.5"
          >
            <svg
              className="w-4 h-4"
              fill="none"
          ...
          <Link
            href="/project/new"
            className="btn-primary text-sm py-2 px-4 rounded-lg no-underline flex items-center gap-1.5"
          >
            <svg
              className="w-4 h-4"
              fill="none"
